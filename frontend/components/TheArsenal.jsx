...
const techStack = [
  {
    ...
    specs: { status: "OPTIMIZED", loadout: "Enterprise Logic, RBAC, Multi-threading" },
  },
  {
    id: "python",
    name: "Python",
    ...
    color: "#3776ab",
    featured: true,
    projects: "4+", // Agentic Platform, Pharma RAG, Course Recommendation [cite: 83, 88, 94]
    years: 3,
    related: ["fastapi", "langchain"],
    specs: { status: "OPERATIONAL", loadout: "Vector Indexing, Semantic Search, Agentic Loops" },
  },
  {
    id: "spring-boot",
    name: "Spring Boot",
    ...
    color: "#6db33f",
    featured: true,
    projects: "3+", // Planet Beyond, Smart AQI [cite: 21, 55, 56]
    years: 1.5,
    related: ["java", "kubernetes", "sql", "postgres", "mail"],
    specs: { status: "OPERATIONAL", loadout: "JWT Auth, REST APIs, Swagger Documentation" },
  },
  {
    id: "react",
    name: "React",
    ...
    projects: "4+",
    years: 1.5,
    related: ["javascript", "fastapi"],
    specs: { status: "OPERATIONAL", loadout: "React Flow, Leaflet Integration, React Native" },
  },
  {
    id: "langchain",
    name: "LangChain / RAG",
    ...
    color: "#121212",
    featured: true,
    projects: 3, // Pharma RAG, Smart AQI Chatbot, Agentic Platform [cite: 23, 84, 90]
    years: 1,
    related: ["python", "faiss"],
    specs: { status: "ACTIVE", loadout: "Contextual Grounding, Tool Use, Vector Stores" },
  },
  {
    id: "docker",
    name: "Docker / K8s",
    ...
    color: "#2496ed",
    featured: false,
    projects: 2, // Planet Beyond Intern Work [cite: 16, 52]
    years: 1,
    related: ["jenkins", "spring-boot"],
    specs: { status: "STABLE", loadout: "Automated Workflows, Containerized Deployment" },
  },
  {
    id: "esp32",
    name: "ESP32 / IoT",
    ...
    color: "#e7352c",
    featured: false,
    projects: 1, // Smart AQI Monitoring Prototype [cite: 22, 35]
    years: 1,
    related: ["mqtt"],
    specs: { status: "DEPLOYED", loadout: "Real-time Telemetry, Sensor Fusion (MQ Series)" },
  },
  {
    id: "sql",
    name: "SQL",
    ...
    color: "#4479a1",
    featured: false,
    projects: 4 , // PostgreSQL (AQI), MySQL (BookStore) [cite: 21, 56, 78]
    years: 2,
    related: ["spring-boot", "java"],
    specs: { status: "STABLE", loadout: "Database Design, Normalization, Persistence" },
  },
];
