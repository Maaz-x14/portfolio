...
const ENDORSEMENTS = [
  {
    ...
    quote:
      "Maaz is an extremely brilliant and quick learner. He demonstrated exceptional skill in architecting complex backend logic with Spring Boot and building highly responsive React interfaces. His ability to deliver production-ready features for our core platforms was impressive.",
    tag: "Full-Stack Excellence",
  },
  {
    id: "VER_NT_02",
    name: "Ayesha Naseer",
    ...
    quote:
      "A standout engineering talent. Maaz possesses a rare combination of technical agility and disciplined learning that makes him an asset to any high-stakes project.",
  ...
  },
  {
    ...
    quote:
      "Extremely dedicated and technically gifted. Maaz consistently demonstrated an advanced understanding of complex software architectures.",
...
export default function Testimonials() {
  return (
    <section
      id="testimonials"
      className="bg-[#EEF4ED] py-32 px-6 relative overflow-hidden border-t border-[#0B2545]/10"
    >
      ...
      <div className="h-full bg-white/40 backdrop-blur-sm border border-black/5 p-10 flex flex-col justify-between transition-all duration-500 group-hover:bg-white group-hover:shadow-2xl">
        <div>
          ...
          <div className="mb-12 relative">
            <span className="absolute -top-6 -left-4 text-6xl text-[#134074]/5 font-serif select-none">
              “
            </span>
        ...
        <div className="pt-8 border-t border-[#0B2545]/10 space-y-4">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-[9px] font-mono text-[#134074]/40 uppercase">
              Email:
            </p>
